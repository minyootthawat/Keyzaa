import { getSellerStatusTone } from "@/app/lib/seller-dashboard";

interface SellerStatusBadgeProps {
  label: string;
}

export default function SellerStatusBadge({ label }: SellerStatusBadgeProps) {
  const tone = getSellerStatusTone(label);
